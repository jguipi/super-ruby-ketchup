...
RSpec.describe ServicesController, type: :controller do
  ...
  let(:valid_attributes) {
    {"nom" => "Nom du service", "description" => "Description du service"}
  }

  let(:invalid_attributes) {
    {"nom" => "", "description" => "Description du service"}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        {"nom" => "Nom du service Updater!", "Description" => "Description du service updater!"}
      }
