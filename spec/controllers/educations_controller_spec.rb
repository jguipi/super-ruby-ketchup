...
RSpec.describe EducationsController, type: :controller do
  ...
  let(:valid_attributes) {
    ...
    employe = Employe.create(:nom => "elnom", :prenom => "elprenom", :organisme_id => organisme.id )
    {"type_education" => "Cégep", "name" => "Technique en Informatique", "employe_id" => employe.id}
  }

  let(:invalid_attributes) {
    organisme = Organisme.create(:name => 'test', :mail => 'test@test.com')
    employe = Employe.create(:nom => "elnom", :prenom => "elprenom", :organisme_id => organisme.id )
    {"type_education" => "", "name" => "", "employe_id" => employe.id}
  }
  ...
  describe "PUT #update" do
    context "with valid params" do
      let(:new_attributes) {
        organisme = Organisme.create(:name => 'test', :mail => 'test@test.com')
        employe = Employe.create(:nom => "elnom", :prenom => "elprenom", :organisme_id => organisme.id )
        {"type_education" => "Secondaire", "name" => "Sciences Naturelles", "employe_id" => employe.id}
      }
